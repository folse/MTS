...
def place_edit(request, objectId):
    ...
    if request.method == "GET":
        ...
        placeForm = Add_Place_Form(initial={'name':place.name,'address':place.address, 'category':category['objectId'], 'phone':place.phone,'open_hour':place.open_hour,'news':place.news,'description':place.description})
