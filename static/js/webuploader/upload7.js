        ...
        function setState( val ) {
            ...
            switch ( state ) {
                ...
                case 'ready':
                    ...
                    $( '#filePicker8' ).removeClass( 'element-invisible');
                    $queue.show();
                ...
                case 'uploading':
                    $( '#filePicker8' ).addClass( 'element-invisible' );
                    $progress.show();
                    $upload.text( 'Pause' );
                    break;
